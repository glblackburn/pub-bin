...
Measure before optimizing. Tracking actual metrics (5m33s → 2m27s) validates the work and shows where to focus. But building the tracking system first enabled data-driven optimization - I could see exactly which tests were slow and where to invest effort.
