...
Detail files for **DEF-001**–**DEF-010**. The **Defect summary** table (status, fix SHAs, manual verification) remains canonical in **[`../plans/plan-002-macos-mouse-click-terminal-ux.md`](../plans/plan-002-macos-mouse-click-terminal-ux.md)**; update the table and the matching **`def-###`** file together when closing a defect.
...
| DEF-010 | `--abort-on-mouse-move` uses wrong reference (burst-start cursor vs click target) | 2026-04-26 | — | **Open** | [def-010-mouse-move-abort-wrong-reference.md](def-010-mouse-move-abort-wrong-reference.md) |
