...
| DEF-009 | Rich pre-run TUI table layout corruption | 2026-04-21 | **Fixed** (script) | [def-009-rich-pre-run-tui-table-layout-corruption.md](def-009-rich-pre-run-tui-table-layout-corruption.md) |
