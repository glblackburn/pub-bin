...
| [plan-agent-cookie-clicker-rate-control.plan.md](plan-agent-cookie-clicker-rate-control.plan.md) | **Phase 1** in-band abort; **Phase 2** inter-click delay / pacing / tuning; **plan-only** until executed. | Active | 2026-04-26 | 2026-04-26 |
