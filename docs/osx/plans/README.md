...
## Shortcut: plan numbers **01**–**14**

The lookup table below maps **01**–**10** (legacy product plan labels) plus **11**–**14** (session notes, design plans, and loop roadmap) to files in this directory.
...
| plan-014 | Post-ladder cookie burst factor (`macos_mouse_click_loop.sh`) | 2026-05-04 | — | Roadmap | [plan-014-macos-mouse-click-loop-cookie-before-ladder.md](plan-014-macos-mouse-click-loop-cookie-before-ladder.md) |
