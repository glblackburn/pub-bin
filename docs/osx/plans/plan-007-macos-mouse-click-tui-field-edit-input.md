...
todos:
  - id: add-plan-07
    content: "Write docs/osx/plans/plan-007-macos-mouse-click-tui-field-edit-input.md"
    status: completed
  - id: phase-07-spec
...
Related: **[`plan-001-macos-clicker.md`](plan-001-macos-clicker.md)** (semantics unchanged), **[`plan-003-macos-mouse-click-tui-automation.md`](plan-003-macos-mouse-click-tui-automation.md)** (post-fix PTY ideas), **[`plan-006-macos-mouse-click-rich-tui-terminal-resize.md`](plan-006-macos-mouse-click-rich-tui-terminal-resize.md)** (separate layout work).
...
- Trim **[plan 03](plan-003-macos-mouse-click-tui-automation.md)** scope table row that referenced **DEF-004** once automation or manual matrix is updated.
