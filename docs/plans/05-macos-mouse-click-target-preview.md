...
todos:
  - id: add-plan-05
    content: "Write docs/plans/05-macos-mouse-click-target-preview.md (goals, options, phases)"
    status: completed
...
It complements **[`01-macos-clicker.md`](01-macos-clicker.md)** (global Quartz coordinates, modes), **[`02-macos-mouse-click-terminal-ux.md`](02-macos-mouse-click-terminal-ux.md)** (pre-run Rich table), **[`03-macos-mouse-click-tui-automation.md`](03-macos-mouse-click-tui-automation.md)** (dry-run exit after editor — machine-readable summary without Quartz), and **[`04-macos-mouse-click-run-progress-ui.md`](04-macos-mouse-click-run-progress-ui.md)** (post-start progress). Plan **05** is specifically **“where is (x,y)?”** and optional **on-glass** feedback.
