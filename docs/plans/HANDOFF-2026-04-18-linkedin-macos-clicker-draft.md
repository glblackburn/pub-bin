...
## docs/plans — engineering context (linked)

Start at the **[plans README / index](README.md)** (status table, **Shipped** vs **Closed (v1)** legend, plan 01 vs 02 distinction).

| Plan | Document | Notes |
|------|----------|--------|
| **01** | [01-macos-clicker.md](01-macos-clicker.md) | **Shipped** behavior spec for [`osx/macos_mouse_click.py`](../../osx/macos_mouse_click.py). |
| **02** | [02-macos-mouse-click-terminal-ux.md](02-macos-mouse-click-terminal-ux.md) | **Closed (v1)** Rich pre-run TTY, **MT-01–MT-09**, **DEF-001–005**; touchpoints to **03–08**. |
| **03** | [03-macos-mouse-click-tui-automation.md](03-macos-mouse-click-tui-automation.md) | **Roadmap** — pytest / PTY / CI for TUI paths. |
| **04** | [04-macos-mouse-click-run-progress-ui.md](04-macos-mouse-click-run-progress-ui.md) | **Roadmap** — post-Start progress UI. |
| **05** | [05-macos-mouse-click-target-preview.md](05-macos-mouse-click-target-preview.md) | **Roadmap** — target preview / show-before-run. |
| **06** | [06-macos-mouse-click-rich-tui-terminal-resize.md](06-macos-mouse-click-rich-tui-terminal-resize.md) | **Roadmap** — **SIGWINCH** / reflow (**DEF-005** deferred here). |
| **07** | [07-macos-mouse-click-tui-field-edit-input.md](07-macos-mouse-click-tui-field-edit-input.md) | **Roadmap** — field-edit input (**DEF-004** deferred here). |
| **08** | [08-macos-mouse-click-stop-during-run.md](08-macos-mouse-click-stop-during-run.md) | **Roadmap** — stop during **`-Y`** / long runs without foreground terminal. |
...
- **`7ec5824`** — Add **[plan 01](01-macos-clicker.md)** (utility plan).
- **`910f272`** — Extend plan **01**; add **[`osx/macos_mouse_click.py`](../../osx/macos_mouse_click.py)**.
- **`93a1f15`** — Add **[plan 02](02-macos-mouse-click-terminal-ux.md)** (Rich TTY).
...
- **`1886e0a`** — Add **[plan 03](03-macos-mouse-click-tui-automation.md)**; link from plan **02**.
- **`8fe0789`** — **MT-02** manual pass; plan **03** **MT-02** automation spec section.
- **`8ddb44d`** — Plan **02**: **MT-03** manual pass.
- **`a1c19b7`**, **`53c9d7d`**, **`51207b7`** — Add **plans [04](04-macos-mouse-click-run-progress-ui.md), [05](05-macos-mouse-click-target-preview.md), [06](06-macos-mouse-click-rich-tui-terminal-resize.md)**; plan **02**: **MT-05–08** done; **DEF-005** deferred to plan **06**.
- **`fc8767b`** — **MT-09** complete; plan **03** **MT-09** pytest notes.
- **`366a04d`** — Add **[plan 07](07-macos-mouse-click-tui-field-edit-input.md)**; **DEF-004** deferred; **plan 02** **Closed (v1)**; plan **03** scope points to plan **07**.
- **`fa31edc`** — Add **[README.md](README.md)** plans index; add **[plan 08](08-macos-mouse-click-stop-during-run.md)**; link from plan **02**.
...
| `docs/plans/HANDOFF-2026-04-18-linkedin-macos-clicker-draft.md` | **This** developer handoff (session + pointers) |
