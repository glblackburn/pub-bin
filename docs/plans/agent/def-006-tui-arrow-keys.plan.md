...
**DEF-006** is recorded in [`02-macos-mouse-click-terminal-ux.md`](../02-macos-mouse-click-terminal-ux.md) (table + subsection + MT links).
...
| File | Role |
|------|------|
| [`02-macos-mouse-click-terminal-ux.md`](../02-macos-mouse-click-terminal-ux.md) | DEF-006 narrative + links |
