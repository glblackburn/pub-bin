...
todos:
  - id: add-plan-08
    content: "Write docs/plans/08-macos-mouse-click-stop-during-run.md"
    status: completed
...
It complements **[`01-macos-clicker.md`](01-macos-clicker.md)** (signals, `shutdown_requested`, `sleep_interruptible`), **[`02-macos-mouse-click-terminal-ux.md`](02-macos-mouse-click-terminal-ux.md)** (pre-run only), and **[`04-macos-mouse-click-run-progress-ui.md`](04-macos-mouse-click-run-progress-ui.md)** (post-start **terminal** feedback — still useless if the terminal is not focused).
