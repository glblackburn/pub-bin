...
| **Plan 02 matrix** | **MT-09** and **MT-02** rows annotated with automation column — see [Manual tests](02-macos-mouse-click-terminal-ux.md#manual-tests-operator-checklist). |
