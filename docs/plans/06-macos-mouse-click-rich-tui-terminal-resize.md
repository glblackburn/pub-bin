...
todos:
  - id: add-plan-06
    content: "Write docs/plans/06-macos-mouse-click-rich-tui-terminal-resize.md"
    status: completed
...
It is motivated by **DEF-005** in **[`02-macos-mouse-click-terminal-ux.md`](02-macos-mouse-click-terminal-ux.md)** (operator **MT-08**, **2026-04-18**): shrinking caused **weird wrap**; expanding the window **did not** grow the rendered UI. Work is **deferred** from v1; no script fix ships until this plan is executed.

Related: **[`04-macos-mouse-click-run-progress-ui.md`](04-macos-mouse-click-run-progress-ui.md)** (post-start **Live** / progress patterns may reuse ideas), **[`03-macos-mouse-click-tui-automation.md`](03-macos-mouse-click-tui-automation.md)** (PTY tests may need **size** assertions after reflow exists).
